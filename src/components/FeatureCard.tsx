...
const FeatureCard = ({
  ...
  return (
    <div className="bg-[#091f2e] rounded-2xl h-56 w-72 border border-[#0b2638] backdrop-blur-lg p-5 flex flex-col justify-between transition-transform duration-300 ease-in-out hover:scale-105 hover:shadow-2xl hover:border-white/20 group">
